...
#endif
//#define MM  	4//8		/* RS code over GF(2**MM) - change to suit */
#define MM 	8
#define KK 	245//This is the number of info bytes plus padding for shortened code! 	
//#define KK	192 /* 223 */		/* KK = number of information symbols */
//#define KK 	11//192 /* 223 */		/* KK = number of information symbols */
